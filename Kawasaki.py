...
class RobotPost(object):
    """Robot post object"""
    PROG_EXT = 'pg'        # set the program extension
    ...
    def MoveJ(self, pose, joints, conf_RLF=None):
        ...
        self.addline('JMOVE #' + joints_2_str(joints))
        
    def MoveL(self, pose, joints, conf_RLF=None):
        """Add a linear movement"""
        self.addline('LMOVE ' + pose_2_str(pose,joints))
    ...
    def setFrame(self, pose, frame_id=None, frame_name=None):
        ...
        self.addline('BASE ' + pose_2_str(pose)) 
    ...
    def setSpeed(self, speed_mms):
        ...
        speed_mms = min(5000, speed_mms)
        self.addline('SPEED %.1f MM/S ALWAYS' % (speed_mms))
    ...
    def setSpeedJoints(self, speed_degs):
        ...
        # consider 500 deg/s the max speed (100%)
        self.addline('SPEED %.1f ALWAYS' % (min(100,100*speed_degs/500)))
    ...
    def setZoneData(self, zone_mm):
        ...
        self.addline('ACCURACY %.3f ALWAYS' % zone_mm)
    ...
    def setDO(self, io_var, io_value):
        ...
        self.addline('SIGNAL %s%s' % (io_value, io_var))
    ...
    def waitDI(self, io_var, io_value, timeout_ms=-1):
        ...
        # at this point, io_var and io_value must be string values
        if timeout_ms > 0:
            self.RunMessage('Timeout not implemented', True)

        self.addline('WAIT SIG(%s%s)' % (io_value, io_var))   
